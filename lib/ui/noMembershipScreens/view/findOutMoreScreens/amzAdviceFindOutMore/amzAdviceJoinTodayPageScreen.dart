...
class amzAdviceJoinTodayPageScreen extends StatefulWidget {
  const amzAdviceJoinTodayPageScreen({super.key});

  @override
  State<amzAdviceJoinTodayPageScreen> createState() =>
      _amzAdviceJoinTodayPageScreenState();
}

class _amzAdviceJoinTodayPageScreenState
    extends State<amzAdviceJoinTodayPageScreen> {
  @override
