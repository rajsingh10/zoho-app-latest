...
class IntroducersBottombar extends StatefulWidget {
  ...
  @override
  State<IntroducersBottombar> createState() => _IntroducersBottombarState();
}
...
class _IntroducersBottombarState extends State<IntroducersBottombar> {
  @override
  void initState() {
          ...
          GestureDetector(
            onTap: () async {
              Get.to(
                WebviewScreen(
                  link:
                      "https://academy.theadvicecentre.ltd/course/the-advice-centre-introducers-on-demand-training#/?previousPage=home&isenrolled=no",
                ),
              );
            },
            child: Column(
